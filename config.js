...
module.exports = {
  botname: process.env.BotName || "soap", 
  author: process.env.Author || "@SoapBotz",
  packname: process.env.PackName || "bravo6",
  socialLink: process.env.Web || "https://github.com/soapmct",
  footer: process.env.Footer || "©mct",
  prefa: process.env.Prefix || ['-'],
  themeemoji: process.env.ThemeEmoji || "🎐",
  ownername: process.env.Owner_Name || "soap",
  ownernumber: process.env.Owner_Number || "919395574966",
